...
| E1-06 | Agendador + catch-up de runs perdidos | **feito** (core: `proxima_execucao`/`tick`/`catch_up`; falta wiring no loop do `app`) | [ADR-0006](../arquitetura/adr/ADR-0006-erro-e-resiliencia.md), [spec scheduler](../specs/scheduler.md) |
...
| ID | História | Estado | ADR/doc |
|---|---|---|---|
| E5-01 | Comandos de listagem/inspeção: `/rotinas`, `/rotina <nome>`, `/uso`, `/status` (evoluir), `/ajuda` dinâmico | proposto | [spec interface](../specs/interface-config-chat.md) |
