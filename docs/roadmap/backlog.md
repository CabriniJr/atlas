...
| E7-33b | **Fase 2 — Kinds `User` + `Credential`** (metadados; segredo no cofre) | proposto | [ADR-0027](../arquitetura/adr/ADR-0027-multiusuario-credenciais.md) |
| E7-33c | **Fase 3 — GitHub device flow** (start/poll → Credential cifrada + git helper escopado; fallback PAT) | proposto | [ADR-0027](../arquitetura/adr/ADR-0027-multiusuario-credenciais.md) |
| E7-33d | **Fase 4 — Auth/sessão** (login; admin via token/loopback) | proposto | [ADR-0027](../arquitetura/adr/ADR-0027-multiusuario-credenciais.md) |
